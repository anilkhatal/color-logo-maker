...
namespace ColorLogoMaker
{
	...
	/// </summary>
	[ToolboxBitmap(typeof(CGFontCombo), "CGFontCombo.bmp")]
	public class CGFontCombo : Control
	{
        ...
        public Int32 FindString(String strItem)
        {
            if (m_comboBox == null)
                return -1;

            return m_comboBox.FindString(strItem, 0);
        }
